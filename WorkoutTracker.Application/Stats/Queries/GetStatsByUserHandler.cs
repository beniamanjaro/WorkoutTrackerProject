...
{
    public class GetStatsByUserHandler : IRequestHandler<GetStatsByUser, string[]>
    {
        ...
        public async Task<string[]> Handle(GetStatsByUser request, CancellationToken cancellationToken)
        {
