...
namespace WorkoutTracker.Infrastructure.Migrations
{
    ...
    [Migration("20221004100900_addedSubscribedWorkoutPlansPropertToUser")]
    partial class addedSubscribedWorkoutPlansPropertToUser
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WorkoutTracker.Domain.Models.WorkoutPlan", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("WorkoutPlan");
                });
            ...
            modelBuilder.Entity("WorkoutTracker.Domain.Models.SubscribedWorkoutPlan", b =>
                {
                    b.HasBaseType("WorkoutTracker.Domain.Models.WorkoutPlan");

                    b.HasIndex("UserId");

                    b.HasDiscriminator().HasValue("SubscribedWorkoutPlan");
                });
            ...
            modelBuilder.Entity("WorkoutTracker.Domain.Models.SubscribedWorkoutPlan", b =>
                {
                    b.HasOne("WorkoutTracker.Domain.Models.User", null)
                        .WithMany("SubscribedWorkoutPlans")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("WorkoutTracker.Domain.Models.User", b =>
                {
                    ...
                    b.Navigation("SubscribedWorkoutPlans");
                });
